...
const Thread = ({ anchor }: { anchor?: string }) => {
  ...
  return (
    <zap-threads anchor={anchor ?? ""} relays={"wss://relay.nostr.band,wss://relay.damus.io,wss://nos.lol"} urls={"tag:nostr.band/?q=%23,note:nostr.band/,nevent:nostr.band/,npub:nostr.band/,nprofile:nostr.band/,naddr:nostr.band/"}/>
  );
};
